...
namespace Skybrud.Social.Slack.Models.Channels {
    ...
    public class SlackChannelPurpose : SlackObject {
        ...
        protected SlackChannelPurpose(JObject obj) : base(obj) {
        ...
        /// <summary>
        /// Parses the specified <paramref name="obj"/> into an instance of <see cref="SlackChannelPurpose"/>.
        /// </summary>
        /// <param name="obj">The instance of <see cref="JObject"/> to parse.</param>
        /// <returns>An instance of <see cref="SlackChannelPurpose"/>.</returns>
        public static SlackChannelPurpose Parse(JObject obj) {
            return obj == null ? null : new SlackChannelPurpose(obj);
        }
